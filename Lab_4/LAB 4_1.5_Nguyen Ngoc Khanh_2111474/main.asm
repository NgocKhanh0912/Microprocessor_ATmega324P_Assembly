;
; LAB 4_1.5_Nguyen Ngoc Khanh.asm
;
; Created: 5/7/2023 2:48:45 AM
; 
;
; ket noi cac tin hieu I2C vao module RTC
; dua tin hieu MFP cua RTC vao 1 chan ngat ngoai
; khoi dong RTC voi thoi gian hien hanh, xuat tin hieu MFP tan so 1 Hz
; su dung ngat ngoai cua AVR, cu moi lan co ngat thi doc thoi gian tu RTC va xuat ra LCD

; MFP KET NOI VOI INT0 LA PD2
; SCL PC0, SDA PC1
; PORTA KET NOI VOI LCD
		...
		.EQU RTC_BUF = 0X200 ; DIA CHI SRAM DE LUU CAC GIA TRI THOI GIAN

		.ORG 0 
		RJMP MAIN
		.ORG 0X02 ; NGAT NGOAI INT0
		RJMP INT0_OUTLCD
...
MAIN:   
		...
		LDI R16, ( 1 << ISC01 )
		STS EICRA, R16 ; NGAT INT0 CANH XUONG
		SBI EIMSK, INT0 ; CHO PHEP NGAT INT0
